    ...
    return(
        <div className="signupdiv">
            <div className="block">
                ...
                <input type="text" placeholder="Enter an unique username to identify you" onChange={(e)=>{setSignupData({...signupData ,"uname":e.target.value});verify(e.target.value)}} className="p-1 mb-1" />
                <div className="text-red-500 text-xs mb-3 p-0 flex items-baseline">
