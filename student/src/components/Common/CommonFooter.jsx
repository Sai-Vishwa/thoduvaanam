      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:hidden px-4 space-y-6">
          <div className="flex items-center justify-center space-x-3">
            ...
            <div>
              <h3 className="text-sm font-semibold text-[#ffffec]">Aadukalam</h3>
              <p className="text-xs text-[#61dafb] font-[Courier_New]">The DSA Battlefield</p>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-[#ffffec]">Team Intellexa</p>
            <p className="text-xs italic text-[#61dafb] mb-1">"Innovate • Impact • Inspire"</p>
            <p className="text-xs text-gray-200">Rajalakshmi Engineering College - Chennai</p>
          </div>
          
          <div className="mx-auto">
            <div className="text-center">
              <p className="mb-2 text-sm text-[#ffffec]">Reach us on</p>
            </div>
