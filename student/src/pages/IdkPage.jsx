...
const ImageCarousel = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen w-screen main">
        <div className="block mx-auto border-2 border-red-200 w-full h-3/5">
            ...
            >
              <div className="relative flex  w-full h-full">
                <img
                  src={image.src}
                  alt={image.name}
                  className={`object-cover bg-red-600 w-full h-full shadow-lg rounded-lg ${isCenter ? 'ring-2 ring-[#61dafb]' : ''}`}
                />
                ...
                {isCenter && isHovering && (
                  <div className="bg-black bg-opacity-80 w-full h-full flex flex-col justify-between p-5  absolute top-0 rounded-lg transition-opacity duration-300 fadeIn">
                    <p className="text-[#61dafb] text-center text-sm h-4/6 overflow-hidden">
                      {typedText}
                      {isTyping && <span className="inline-block w-1 h-4 bg-white ml-1 animate-ping"></span>}
                    </p>
                    <div className="flex justify-center space-x-2 text-xs">
                      <a href={image.github} target="_blank" rel="noopener noreferrer" className="flex items-center text-white  transition-colors">
                        <svg className="w-4 h-4 mr-1" fill="#61dafb" viewBox="0 0 24 24">
                      ...
                      <a href={image.linkedin} target="_blank" rel="noopener noreferrer" className="flex items-center text-white hover:text-blue-300  cursor-potransition-colors">
                        <svg className="w-4 h-4 mr-1" fill="#61dafb" viewBox="0 0 24 24">
      ...
      <div className="text-lg font-semibold text-white transition-all duration-500 ease-in-out">
        {images[currentIndex].name}
      </div>
      <div className="text-xs font-semibold text-white transition-all duration-500 ease-in-out">
        {images[currentIndex].name}
      </div>
