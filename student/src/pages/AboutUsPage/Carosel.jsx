        ...
        {images.map((image, index) => {
          ...
          return (
            ...
            >
              ...
              {isCenter && <div className="text-lg font-semibold text-white transition-all duration-500 ease-in-out">
                {images[currentIndex].name}
            </div>}
            {isCenter && <div className="text-xs font-semibold text-white transition-all duration-500 ease-in-out">
