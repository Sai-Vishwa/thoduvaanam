...
<Toaster
      ...
      />
        ...
        <div className="text-[#61dafb] mt-2 w-full h-1/6 text-2xl md:text-3xl tracking-[-0.1em] flex flex-col sm:flex-row font-[Liberty] sm:space-x-5">
        ...
        <div className="w-full mx-auto  h-[62vh] mt-4 bg-[#121212] rounded-md border border-[#2b2b2b] text-[#ffffec] flex flex-col shadow-lg overflow-hidden">
          {/* Terminal Header */}
